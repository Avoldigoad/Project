    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" >
                ...
                <!-- <img src="{{asset('sbadmin/img/Dollar.png')}}" alt=""> -->
                <div class="sidebar-brand-text mx-3">KasKelas
                <!-- <img src="{{asset('sbadmin/img/Dollar.png')}}" alt="" class=""> -->
                </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="buttons.html">Tambah Transaksi</a>
                        <!-- <a class="collapse-item" href="cards.html">Cards</a> -->
                        <a class="collapse-item" href="buttons.html">Riwayat Transaksi</a>
                    </div>
                </div>
            </li>
